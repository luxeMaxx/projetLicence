...
import { FaClock, FaClosedCaptioning, FaComments, FaHome, FaHourglass, FaHouseUser, FaQuestion, FaRegClock, FaRegUser, FaRegUserCircle, FaSearch, FaStar, FaUser, FaUserAlt, FaUserAltSlash, FaWpforms } from "react-icons/fa"
...
const Dashboard = () => {
    ...
    return (
        <div className = {D.dashboard}>
               <Modal>
                <div className = {D.popup_content}>
                    <FaQuestion/>
                    <p className = {D.infos_content} id = "content_popup">
