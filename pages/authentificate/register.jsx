...
import { FaCheck, FaCheckCircle } from "react-icons/fa";
 ...
 export function validInputText ( value, id_error, type) {
    ...
    if ( type === "text" ) {
        ...
        if ( !value ) {
            error.textContent = "Veuillez entré le message a envoyé...";
            return false;
        } else if ( value.length < 5 ) {
            error.textContent = "le message est trop court..";
            return false;
        } else if ( regexTextarea.test ( value ) == false ) {
            error.textContent = "Entré du text clair...";
            return false;
        } else {
            error.textContent = "";
            return true;
        ...
        if ( value.length == 0 ) {
            error.textContent = "Choisissez un fichier...";
            return false;
        } else {
            error.textContent = "";
            return true;
...
const Register = () => {
    ...
    const handleSubmit = e => {
        ...
        var v1 = document.getElementById ("animation");
        var v2 = document.getElementById ("success");
        ...
        <div className = {L.login_block}>
            <Modal>
                <div className = {L.animation}>
                  {/*   <div className = {L.circle1} id = "anim">
                    ...
                    <div className = {L.anim_div2} id = "success">
                        ...
                        <a href="/seConnecter">Connectez-vous</a>
                    </div>
                </div>
            </Modal>
